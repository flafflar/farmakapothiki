...
class Ui_MainWindow(object):
    ...
    def update_table(self, data):
        ...
        for row_num, product in enumerate(data):
            ...
            self.tableWidget.setItem(row_num, 2, QTableWidgetItem(str(product.category.name)))
            self.tableWidget.setItem(row_num, 3, QTableWidgetItem(str(product.company.name)))
            ...
            self.tableWidget.setCellWidget(row_num, data_coloumns, edit_button)
            ...
            self.tableWidget.setCellWidget(row_num, data_coloumns+1, info_button)
